    ...
    <div className="relative">
      <button
        ...
        className={`inline-flex items-center gap-1.5 rounded-full px-3.5 py-2 text-[12.5px] font-semibold transition-colors ${
          open ? "bg-[#EAF1F8] text-[#0B4171]" : "text-[#64748B] hover:bg-[#F1F5F9] hover:text-[#0F172A]"
        }`}
      >
      ...
      {open ? (
        <>
          ...
          />
          <div className="absolute right-0 top-[calc(100%+8px)] z-50 w-[420px] overflow-hidden rounded-[16px] bg-[#0B2A47] text-[#E2E8F0] shadow-[0_24px_48px_-16px_rgba(11,42,71,0.45)]">
